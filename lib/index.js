...
//					log("setting count: " + arg);
	...
	'addme': {
		command: function(options) {
			...
			if (!options.cmbot.isFFA()) {
				if(!options.cmbot.options.allow_mobile_djs && (options.cmbot.users[options.userid].laptop == 'iphone' || options.cmbot.users[options.userid].laptop == 'android') && options.cmbot.settings.mobileWhitelist[options.userid] == undefined) {
