...
//					log("setting count: " + arg);
	...
	'addme': {
		command: function(options) {
			...
			if (!options.cmbot.isFFA()) {
				if((options.cmbot.users[options.userid].laptop == 'iphone' || options.cmbot.users[options.userid].laptop == 'android') && cmbot.settings.mobileWhitelist[newDj.userid] == undefined) {
